...
- **Screen Mounting**: Search for "### Screen Mounting" - MoquiConf.xml subscreens-item patterns
- **Include Screen**: Search for "### Include Screen" - include-screen, transition-include reuse
- **Artifact Authorization**: Search for "### Artifact Authorization" - authz seed data patterns
