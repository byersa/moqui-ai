...
The `.agent` directory within the workspace is the designated location for agent-related configuration, rules, and memory. System directories like `~/.antigravity` should strictly be used for internal agent state and history, never for user-facing artifacts unless explicitly requested for archival.
