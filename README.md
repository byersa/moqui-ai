...
- **SPA App Shell**: Provides a unified Freemarker/Vue.js wrapper (`Quasar2Wrapper.qvt.ftl`) that handles client-side routing via `vue-router` while adhering to the Moqui screen path structure.
